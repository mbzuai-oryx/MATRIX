...
def rank0_alert():
    if local_rank == 0:
        import wandb
        wandb.init(project="mat_qwen_vl_gaia")
        wandb.alert(title="Training Started", text="Training has started")
...
def train():
    ...
    tokenizer.im_start_id = im_start_id
    tokenizer.im_end_id = im_end_id
